...
"""
Uniform grid generation + depths + speeds.
"""
...
if __name__ == "__main__":
    ...
    DEPTHS = np.arange(DEPTH_INC, 3e-2 + DEPTH_INC, DEPTH_INC) # plunge depths
    # ***Add times***
    TIME_INC = 5  # time increment (s)
    PLUNGE_TIME = np.arange(1, 4 + TIME_INC, TIME_INC)  # plunge times (s)
    ...
    # ***Incorporate depths and speeds in the grid***
