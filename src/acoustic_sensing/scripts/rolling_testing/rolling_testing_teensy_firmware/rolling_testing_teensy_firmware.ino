...
constexpr uint16_t SAMPLES_PER_CHANNEL = static_cast<uint16_t>(
    (SAMPLE_RATE / SPEED_OF_SOUND_M_S) * 2.0f * RANGING_DISTANCE_M * 1.2f
);

// Match src/acoustic_sensing/teensy_firmware/teensy4_1_MB1340_4x/teensy4_1_MB1340_4x.ino
