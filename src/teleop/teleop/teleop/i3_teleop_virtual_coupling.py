"""
To teleop the FR3 with the Inverse 3 using virtual coupling.

This needs the `haptic_controller` running on the server to work.
...
class I3TeleopVirtualCoupling(Node):
    def __init__(self):
