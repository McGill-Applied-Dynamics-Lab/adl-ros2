...
from arm_client.teleop.inverse3_teleop import Inverse3Config, Inverse3Teleop
...
def main() -> None:
    ...
    i3 = Inverse3Teleop(initial_robot_position=initial_robot_position, config=config)
