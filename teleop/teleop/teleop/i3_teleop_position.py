"""
To compute robot desired end-effector position based on the i3 position.

Modified version of `i3_teleop.py` to work with the OSC PD controller.
"""
...
class I3Teleop(Node):
    def __init__(self):
        ...
        self.declare_parameter("position_scale", 3.0)
    ...
    def _init_subscribers(self):
        ...
        # --- ee pose ---
        robot_topic = "/franka_robot_state_broadcaster/current_pose"
    ...
    def _init_publishers(self):
        ...
        # Pose Publisher
        self._ee_cmd_pub_topic = self._cmd_topic
        self._ee_cmd_pub = self.create_publisher(PointStamped, self._ee_cmd_pub_topic, 10)
        self._ee_cmd_msg = PointStamped()
    ...
    def _compute_ee_command(self):
        ...
        if self._control_mode == ControlModes.POSITION:
            ...
            self._ee_cmd_msg.point.x = ee_pose_des[0]
            self._ee_cmd_msg.point.y = ee_pose_des[1]
            self._ee_cmd_msg.point.z = ee_pose_des[2]
